				...
				<div class="collapse navbar-collapse" id="collapsibleNavId">
					<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
						...
						<li class="nav-item"><a class="nav-link" href="Admin/VideosManagement"  > <i
								class="fa fa-info" aria-hidden="true" id="videos"></i> Videos
						</a></li>
						<div class="nav-item">
							<a href="UserManagement" class="nav-link"> <i class="fa fa-id-card"
								aria-hidden="true"></i> Users
							</a>
						</div>
						<div class="nav-item">
							<a href="ReportsManagementServlet" class="nav-link"> <i class="fa fa-comments"
